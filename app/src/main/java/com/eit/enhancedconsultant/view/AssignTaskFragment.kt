...
class AssignTaskFragment : Fragment()
{
                              ...
                              savedInstanceState: Bundle?): View?
    {
        ...
        taskId = "id${SimpleDateFormat("HHmmssSSS",
            Locale.ENGLISH).format(now.time)}"

        // Next two hours
        now.add(Calendar.HOUR, 2)

        var taskIdDisplay = "Task Id: $taskId"
        ...
        btnAssignTask.setOnClickListener {
            ...
            if(validateTask())
            {
                val assignor = "${MainActivity.currentUser!!.firstName} " +
                        MainActivity.currentUser!!.lastName
                listener.assignTask(
                    tilTaskTitle.editText.toString(),
                    tilEmail.editText.toString(),
                    edtTaskDescription.text.toString(),
                    assignor, mStartDate, mDueDate)
                ...
                taskIdDisplay = "Task Id: $taskId"
                txvTaskId.text = taskIdDisplay
